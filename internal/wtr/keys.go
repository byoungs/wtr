...
var keys = keyMap{
	...
	ViewOutput: key.NewBinding(key.WithKeys("v"), key.WithHelp("v", "view output")),
	...
	Squash:   key.NewBinding(key.WithKeys("s"), key.WithHelp("s", "squash onto main")),
	Rebase:   key.NewBinding(key.WithKeys("r"), key.WithHelp("r", "rebase on main")),
	Help:     key.NewBinding(key.WithKeys("h", "?"), key.WithHelp("h/?", "help")),
	Refresh:  key.NewBinding(key.WithKeys("u"), key.WithHelp("u", "refresh")),
	Open:      key.NewBinding(key.WithKeys("o"), key.WithHelp("o", "open in VS Code")),
